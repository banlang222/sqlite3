...
enum OperatingSystem { android, linux, iOS, macOS, windows, fuchsia, ohos }
...
DynamicLibrary _defaultOpen() {
  ...
  } else if (Platform.isLinux || Platform.operatingSystem == 'ohos') {
...
class OpenDynamicLibrary {
  ...
  OperatingSystem? get os {
    ...
    if (Platform.operatingSystem == 'ohos') return OperatingSystem.ohos;
    return null;
  }
